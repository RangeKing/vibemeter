    ...
    <div className="page reviews-page">
      ...
      <div className="reviews-workspace">
        ...
        {selected ? <article className="review-editor">
          ...
          <footer className="review-footer"><AgentBadge agent="aftervibe" compact /><span>{formatDateTime(selected.updatedAt, locale)} · {selected.userEdited ? t("actions.edit") : t("actions.generate")}</span></footer>
        </article> : null}
      </div>
