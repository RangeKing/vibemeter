...
describe("localization resources", () => {
  ...
  it("distinguishes exact live and historical-only sources", () => {
    expect(zhCN.live.description).toContain("精确实时生命周期");
    expect(zhCN.live.description).not.toContain("实验性近期活动");
    ...
    expect(enUS.live.description).not.toContain("experimental recent activity");
